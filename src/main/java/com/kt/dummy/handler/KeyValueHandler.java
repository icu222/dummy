...
public class KeyValueHandler extends SimpleChannelInboundHandler<ByteBuf> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, ByteBuf msg) throws Exception {
        try {
            ...
            String responseContent = ResponseMapManager.getInstance()
                .getResponse(stage, "keyValue", responseKey);
            
            if (responseContent == null) {
                logger.warn("응답 전문 없음: stage={}, protocol=keyValue, api={}", stage, responseKey);
    ...
    private String determineStageFromPort(int port) {
        // B그룹 포트 매핑
        switch (port) {
            case 18000: return "stage1";
            case 19000: return "stage2";
            case 20000: return "stage3";
            case 10120: return "stage4";
